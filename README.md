...
- **Configuration**: optional manual credentials for the Matomo database used by the password reset
...
### Version 2.6.1
- consent_kit integration via a shared repository detection (see 2.6.2)
